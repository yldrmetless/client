...
import { furnitureArr } from "../../images";
    ...
    <div>
      <div className="w-full lg:h-screen relative">
        <div className="relative w-full">
          <img src={furniture} alt="" className="w-full  lg:h-screen" />
      ...
      <div className="max-w-full w-full mx-auto p-3 flex flex-col justify-center items-center gap-8 py-7 2xl:mt-32">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-6 mt-8">
            {furnitureArr.map((post) => (
