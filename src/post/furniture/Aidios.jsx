...
import { aidios } from "../../../images";
import aidiosImg from "../../assets/PROJECTS-GALLERY/5-FURNITURE-PRODUCT-DESIGN-(FURNITURE-PRODUCT)/AIDIOS TABLE & CONSOLE/1.jpg";

const images = aidios.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
