...
import { blade } from "../../../images";
import bladeImg from "../../assets/PROJECTS-GALLERY/5-FURNITURE-PRODUCT-DESIGN-(FURNITURE-PRODUCT)/BLADE CONSOLE/1.jpg";

const images = blade.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
