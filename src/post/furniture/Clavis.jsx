...
import { clavisArr } from "../../../images";
import clavisImg from "../../assets/PROJECTS-GALLERY/5-FURNITURE-PRODUCT-DESIGN-(FURNITURE-PRODUCT)/CLAVIS TV WALL/1.jpg";

const images = clavisArr.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
