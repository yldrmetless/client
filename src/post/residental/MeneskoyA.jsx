...
import { meneskoy } from "../../../images";
import meenskoyImg from "../../assets/PROJECTS-GALLERY/2-CONTEMPORARY-PROJECTS-(RESIDENTAL)/PRIVATE VILLA A BLOK-MENESKÖY İZMİR/1.jpg";


const images = meneskoy.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
    ...
    <div className="relative">
      <div className="relative">
        ...
        <h1 className="text-3xl p-3 text-center font-serif max-w-full w-full mx-auto lg:text-5xl md:text-4xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white font-sixth font-semibold">
          PRIVATE VILLA A BLOK - MENESKOY İZMİR
        </h1>
      </div>
