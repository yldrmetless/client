...
import { sg } from "../../../images";
import sgImg from "../../assets/PROJECTS-GALLERY/1-PRIVATE-RESIDENTAL-PROJECTS(RESIDENTAL)/Ş.G. PRIVATE VILLA-ISTANBUL/1.jpg";


const images = sg.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
