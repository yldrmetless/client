...
import { menderes } from "../../../images";
import menderesImg from "../../assets/PROJECTS-GALLERY/1-PRIVATE-RESIDENTAL-PROJECTS(RESIDENTAL)/H.D. PRIVATE HOUSE- MENDERES/1.jpg";


const images = menderes.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
