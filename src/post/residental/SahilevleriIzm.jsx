...
import { shl } from "../../../images";
import shlImg from "../../assets/PROJECTS-GALLERY/1-PRIVATE-RESIDENTAL-PROJECTS(RESIDENTAL)/PRIVATE VILLA-SAHİLEVLERİ İZMİR/SALON/1.jpg";


const images = shl.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
    ...
    <div className="relative">
      <div className="relative">
        ...
        <h1 className="text-3xl p-3 text-center font-serif max-w-full w-full mx-auto lg:text-5xl md:text-4xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white font-sixth font-semibold">
          PRIVATE VILLA - SAHİLEVLERİ İZMİR
        </h1>
      </div>
