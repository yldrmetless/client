...
import { mesa } from "../../../images";
import mesaImg from "../../assets/PROJECTS-GALLERY/1-PRIVATE-RESIDENTAL-PROJECTS(RESIDENTAL)/MESA BODRUM DEMİRBÜKÜ/1.jpg";


const images = mesa.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
