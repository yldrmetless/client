...
import { vadi } from "../../../images";
import urla from "../../assets/PROJECTS-GALLERY/1-PRIVATE-RESIDENTAL-PROJECTS(RESIDENTAL)/VADİ KEKLİKTEPE-URLA İZMİR/1.jpg";


const images = vadi.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
