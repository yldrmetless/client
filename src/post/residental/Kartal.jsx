...
import { kartal } from "../../../images";
import kartalImg from "../../assets/PROJECTS-GALLERY/1-PRIVATE-RESIDENTAL-PROJECTS(RESIDENTAL)/LUXURY BEDROOM-KARTAL YUVASI BODRUM/1.jpg";


const images = kartal.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
    ...
    <div className="relative">
      <div className="relative">
        ...
        <h1 className="text-3xl p-3 text-center font-serif max-w-full w-full mx-auto lg:text-5xl md:text-4xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white font-sixth font-semibold">
          LUXURY BEDROOM - KARTAL YUVASI BODRUM
        </h1>
      </div>
