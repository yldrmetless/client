...
import { cuzdan } from "../../../images";
import cuzdanImg from "../../assets/PROJECTS-GALLERY/4-OFFICE-PROJECTS-(OFFICE)/CÜZDAN-ATAŞEHİR İSTANBUL/1.jpg";

const images = cuzdan.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
