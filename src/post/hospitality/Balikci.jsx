...
import { balikci } from "../../../images";
import balikciImg from "../../assets/PROJECTS-GALLERY/3-HOSPITALITY-(HOSPITALITY)/BALIKÇI HASAN-ALSANCAK İZMİR/1.jpg";

const images = balikci.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
