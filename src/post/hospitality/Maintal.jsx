...
import { maintal } from "../../../images";
import maintalImg from "../../assets/PROJECTS-GALLERY/3-HOSPITALITY-(HOSPITALITY)/ARKADASH DONER RESTAURANT-MAINTAL GERMANY/1.jpg";

const images = maintal.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
    ...
    <div className="relative">
      <div className="relative">
        ...
        <h1 className="text-3xl p-3 text-center font-serif max-w-full w-full mx-auto lg:text-5xl md:text-4xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white font-sixth font-semibold">
            ARKADASH DONER RESTAURANT-MAINTAL GERMANY
        </h1>
      </div>
