...
import { concept } from "../../../images";
import conceptImg from "../../assets/PROJECTS-GALLERY/3-HOSPITALITY-(HOSPITALITY)/CONCEPT RESTAURANT- FRANCE/1.jpg";

const images = concept.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
