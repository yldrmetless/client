...
import { moodbard } from "../../../images";
import moodbardImg from "../../assets/PROJECTS-GALLERY/6-FFE-SERVICE-STYLING-(FFE-SERVICE)/moodboard/1.jpg";

const images = moodbard.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
