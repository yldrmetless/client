...
import { konseptev } from "../../../images";
import konsept from "../../assets/PROJECTS-GALLERY/6-FFE-SERVICE-STYLING-(FFE-SERVICE)/konsept ev/1.jpg";

const images = konseptev.map((post) => ({
  original: post.img,
  thumbnail: post.img,
}));
const galleryStyles = {
