 ...
 */
import type { CanPromise, IControlType, IViewBased, IJodit, RejectablePromise, Nullable } from "jodit/esm/types";
/**
...
export declare const memorizeExec: <T extends IJodit = IJodit>(editor: T, _: unknown, { control }: {
    control: IControlType<T, import("jodit/esm/types").IToolbarButton>;
